                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tr>
                        ...
                        <td class="center">
                            ...
                            if($v_blog->publication_status==1){
                            ?>
                            <a class="btn btn-danger" href="{{URL::to('/unpublish_user_blog/'.$v_blog->blog_id)}}">
                            ...
                            ?>
                            <a class="btn btn-success" href="{{URL::to('/publish_user_blog/'.$v_blog->blog_id)}}">
                                <i class="halflings-icon white thumbs-up"></i>
                            </a>
                            <?php } ?>

                            <a class="btn btn-danger" href="{{URL::to('/delete_user_blog/'.$v_blog->blog_id)}}" onclick="return check_delete();">
